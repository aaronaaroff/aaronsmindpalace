 ...
 * https://modernizr.com/download/?-adownload-animation-atobbtoa-audio-backgroundblendmode-backgroundcliptext-bgsizecover-boxsizing-canvas-canvasblending-canvastext-canvaswinding-cookies-cssanimations-csscalc-csscolumns-cssfilters-cssgradients-csshyphens_softhyphens_softhyphensfind-cssscrollbar-csstransforms-csstransforms3d-csstransitions-cssvhunit-cssvwunit-emoji-flexbox-flexboxlegacy-flexboxtweener-fontface-forcetouch-fullscreen-hashchange-hiddenscroll-history-inlinesvg-json-ligatures-localstorage-picture-placeholder-requestanimationframe-sessionstorage-sizes-srcset-svg-svgclippaths-svgfilters-todataurljpeg_todataurlpng_todataurlwebp-touchevents-video-webaudio-webgl-webp-webpalpha-webpanimation-printshiv-setclasses !*/
!function (e, t, n) {
    function r(e, t) {
        return typeof e === t
    }
    ...
    function a(e) {
        ...
        Modernizr._config.enableClasses && (t += " " + n + e.join(" " + n),
            x ? T.className.baseVal = t : T.className = t)
    }
    function i() {
    ...
    function d() {
        var e = t.body;
        return e || (e = i(x ? "svg" : "body"),
            e.fake = !0),
            e
    }
    function c(e, n, r, o) {
        var a, s, l, c, u = "modernizr", f = i("div"), p = d();
        if (parseInt(r, 10))
            for (; r--;)
                l = i("div"),
                    l.id = o ? o[r] : u + (r + 1),
    ...
    function p(e, t, n) {
        ...
        for (var a in e)
            if (e[a] in t)
                return n === !1 ? e[a] : (o = t[e[a]],
                    r(o, "function") ? f(o, n || t) : o);
        return !1
    }
    function m(e) {
    ...
    function h(e, t, o, a) {
        ...
        for (var c, f, p, m, h, g = ["modernizr", "tspan", "samp"]; !Q.style && g.length;)
            c = !0,
                Q.modElem = i(g.shift()),
    ...
    function g(e, t, n, o, a) {
        ...
        return r(t, "string") || r(t, "undefined") ? h(s, t, o, a) : (s = (e + " " + M.join(i + " ") + i).split(" "),
            p(s, t, n))
    }
    function v(e, t, r) {
        return g(e, n, n, t, r)
    ...
    x || !function (e, t) {
        ...
        function i(e, n, r) {
            ...
            r || (r = a(n));
            var o;
            return o = r.cache[e] ? r.cache[e].cloneNode() : y.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e),
                !o.canHaveChildren || b.test(e) || o.tagUrn ? o : r.frag.appendChild(o)
        }
        function s(e, n) {
            if (e || (e = t),
                h)
        ...
        function d(e) {
            e || (e = t);
            var r = a(e);
            return !C.shivCSS || A || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
                h || l(e, r),
                e
        }
        function c(e) {
            for (var t, n = e.getElementsByTagName("*"), o = n.length, a = RegExp("^(?:" + r().join("|") + ")$", "i"), i = []; o--;)
                t = n[o],
                    a.test(t.nodeName) && i.push(t.applyElement(u(t)));
            return i
        }
        function u(e) {
            for (var t, n = e.attributes, r = n.length, o = e.ownerDocument.createElement(S + ":" + e.nodeName); r--;)
                t = n[r],
        ...
        function f(e) {
            for (var t, n = e.split("{"), o = n.length, a = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), i = "$1" + S + "\\:$2"; o--;)
                t = n[o] = n[o].split("}"),
        ...
        function m(e) {
            ...
            var r, o, i = a(e), s = e.namespaces, l = e.parentWindow;
            return !k || e.printShived ? e : ("undefined" == typeof s[S] && s.add(S),
                l.attachEvent("onbeforeprint", function () {
                    t();
                    for (var a, i, s, l = e.styleSheets, d = [], u = l.length, p = Array(u); u--;)
                        p[u] = l[u];
                    for (; s = p.pop();)
        ...
        var A, h, g = "3.7.3", v = e.html5 || {}, b = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, y = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, w = "_html5shiv", T = 0, x = {};
        !function () {
            try {
                var e = t.createElement("a");
                e.innerHTML = "<xyz></xyz>",
                    A = "hidden" in e,
                    h = 1 == e.childNodes.length || function () {
                        t.createElement("a");
        ...
        Modernizr.addTest("canvasblending", function () {
            if (Modernizr.canvas === !1)
                return !1;
            var e = i("canvas").getContext("2d");
            try {
    ...
    Modernizr.addTest("todataurljpeg", function () {
        return !!Modernizr.canvas && 0 === C.toDataURL("image/jpeg").indexOf("data:image/jpeg")
    }),
        Modernizr.addTest("todataurlpng", function () {
            return !!Modernizr.canvas && 0 === C.toDataURL("image/png").indexOf("data:image/png")
        }),
        Modernizr.addTest("todataurlwebp", function () {
            var e = !1;
            try {
                e = !!Modernizr.canvas && 0 === C.toDataURL("image/webp").indexOf("data:image/webp")
            } catch (t) { }
            return e
        }),
    ...
    w._prefixes = S,
        Modernizr.addTest("csscalc", function () {
            var e = "width:"
                , t = "calc(10px);"
                , n = i("a");
            return n.style.cssText = e + S.join(t + e),
                !!n.style.length
        }),
        Modernizr.addTest("cssgradients", function () {
            for (var e, t = "background-image:", n = "gradient(linear,left top,right bottom,from(#9f9),to(white));", r = "", o = 0, a = S.length - 1; a > o; o++)
                e = 0 === o ? "to " : "",
    ...
    var k = "CSS" in e && "supports" in e.CSS
        , B = "supportsCSS" in e;
    Modernizr.addTest("supports", k || B);
    var R = {}.toString;
    Modernizr.addTest("svgclippaths", function () {
        return !!t.createElementNS && /SVGClipPath/.test(R.call(t.createElementNS("http://www.w3.org/2000/svg", "clipPath")))
    });
    var _;
    !function () {
        ...
        Modernizr.addAsyncTest(function () {
            var e, t, n, r = i("img"), o = "sizes" in r;
    ...
    Modernizr.addTest("hiddenscroll", function () {
        return P("#modernizr {width:100px;height:100px;overflow:scroll}", function (e) {
    ...
    D ? Modernizr.addTest("fontface", !1) : P('@font-face {font-family:"font";src:url("https://")}', function (e, n) {
        ...
        P("#modernizr{overflow: scroll; width: 40px; height: 40px; }#" + S.join("scrollbar{width:0px} #modernizr::").split("#").slice(1).join("#") + "scrollbar{width:0px}", function (e) {
        ...
        P("#modernizr { width: 50vw; }", function (t) {
    ...
    var j = "Moz O ms Webkit"
        , O = w._config.usePrefixes ? j.split(" ") : [];
    w._cssomPrefixes = O;
    var U = function (t) {
        var r, o = S.length, a = e.CSSRule;
    ...
    w.atRule = U;
    var M = w._config.usePrefixes ? j.toLowerCase().split(" ") : [];
    w._domPrefixes = M;
    var N = {
        elem: i("modernizr")
    };
    ...
    var z = w.prefixed = function (e, t, n) {
        return 0 === e.indexOf("@") ? U(e) : (-1 != e.indexOf("-") && (e = s(e)),
            t ? g(e, t, n) : g(e, "pfx"))
    }
        ;
    Modernizr.addTest("forcetouch", function () {
        return E(z("mouseforcewillbegin", e, !1), e) ? MouseEvent.WEBKIT_FORCE_AT_MOUSE_DOWN && MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN : !1
    }),
        Modernizr.addTest("fullscreen", !(!z("exitFullscreen", t, !1) && !z("cancelFullScreen", t, !1))),
        ...
        w.testAllProps = v,
        Modernizr.addTest("ligatures", v("fontFeatureSettings", '"liga" 1')),
            ...
            function n() {
                function o() {
                    try {
                        ...
                        return e.appendChild(n),
                            ...
                            r.cssText = "position:absolute;top:0;left:0;width:5em;text-align:justify;text-justification:newspaper;",
                            o = n.offsetHeight,
                            a = n.offsetWidth,
                            r.cssText = "position:absolute;top:0;left:0;width:5em;text-align:justify;text-justification:newspaper;" + S.join("hyphens:auto; "),
                            s = n.offsetHeight != o || n.offsetWidth != a,
                ...
                function a(e, n) {
                    try {
                        ...
                        return a.cssText = "position:absolute;top:0;left:0;overflow:visible;width:1.25em;",
                            r.appendChild(o),
                            t.body.insertBefore(r, u),
                            o.innerHTML = "mm",
                            s = o.offsetHeight,
                            o.innerHTML = "m" + e + "m",
                            d = o.offsetHeight > s,
                            n ? (o.innerHTML = "m<br />m",
                                s = o.offsetWidth,
                                o.innerHTML = "m" + e + "m",
                                c = o.offsetWidth > s) : c = !0,
                            d === !0 && c === !0 && (l = !0),
                ...
                function s(n) {
                    try {
                        var r, o = i("input"), a = i("div"), s = "lebowski", l = !1, d = t.body.firstElementChild || t.body.firstChild;
                        a.innerHTML = s + n + s,
                            t.body.insertBefore(a, d),
                            t.body.insertBefore(o, a),
                            o.setSelectionRange ? (o.focus(),
                                o.setSelectionRange(0, 0)) : o.createTextRange && (r = o.createTextRange(),
                                    r.collapse(!0),
                                    r.moveEnd("character", 0),
                                    r.moveStart("character", 0),
                                    r.select());
                        try {
                            e.find ? l = e.find(s + s) : (r = e.self.document.body.createTextRange(),
                                l = r.findText(s + s))
                        } catch (c) {
                            l = !1
                        }
